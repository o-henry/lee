    ...
    <>
      <div className="">
        <div className="pb-8 pt-10">
          ...
          <p className="font-acc">
            I am a developer with a keen interest in web and app development. 
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="16" viewBox="0.523925 0.394531 431 37.2" fill="none" 
          className="-mt-2 mb-2 stroke-black dark:stroke-white">
                  ...
                  <div className="space-y-2 xl:grid xl:grid-cols-2 xl:items-baseline xl:space-y-0">
                    ...
                    <div className="space-y-5 xl:col-span-3">
                      <div className="space-y-6">
                        <div>
                          <h2 className="text-xl font-acc font-bold leading-8 tracking-tight">
                            <Link
                              href={`/blog/${slug}`}
                          ...
                          <div className="flex flex-wrap mt-1.5 -mx-1">
                            {tags.map((tag) => (
